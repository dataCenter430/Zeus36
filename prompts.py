...
def build_system_prompt() -> str:
    return (
        ...
        "TOOLS: Return {\"tool\":\"<name>\",\"args\":{...}} to inspect page before acting. "
        "Tools: list_cards({}); search_text({query}); list_links({}); extract_forms({}).\n"
...
def build_user_prompt(
    *,
    ...
    # --- Website hints (only on early steps to save tokens) ---
